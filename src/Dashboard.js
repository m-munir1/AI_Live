...
class Body extends Component {
	...
	@computed get personal() {
		return this.permissions.filter(tool => tool.category === 'Personligt')
	}

	@computed get business() {
		return this.permissions.filter(tool => tool.category === 'Verksamt')
	}
	...
	@computed get content() {
		return this.permissions.filter(tool => tool.category === 'Skriftligt Material')
	}

	@computed get programming() {
		return this.permissions.filter(tool => tool.category === 'Programmering')
	}
	...
	return (
		...
		<>
			<Helmet>
				<title>{`Tools - Riksakademins AI`}</title>
			</Helmet>
			...
			{this.content.length ? <>
				<Title title="Skriftligt Material" />
				<Grid>
